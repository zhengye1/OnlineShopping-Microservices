...
public class SnowflakeIdGenerator {
    ...
    public static final int MAX_DATACENTER = (1 << DATACENTER_BITS) - 1;    // 31
    public static final int MAX_WORKER = (1 << WORKER_BITS) - 1;       // 31
    public static final int MAX_SEQUENCE = (1 << SEQUENCE_BITS) - 1;      // 4095

    public static final int WORKER_SHIFT = SEQUENCE_BITS;                                   // 12
    public static final int DATACENTER_SHIFT = SEQUENCE_BITS + WORKER_BITS;                    // 17
    public static final int TIMESTAMP_SHIFT = SEQUENCE_BITS + WORKER_BITS + DATACENTER_BITS;  // 22
